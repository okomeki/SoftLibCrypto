...
public class SHA256Test {
    ...
    public void testSomeMethod() throws UnsupportedEncodingException {
        ...
        assertArrayEquals("SHA-224",r,toHex(SHA224m));
...
//        assertArrayEquals(r,toHex(SHA224e));
        ...
        md = new SHA256();
        r = md.digest("".getBytes("utf-8"));
        assertArrayEquals("SHA-256",r,toHex(SHA256e));

        r = md.digest("abc".getBytes("utf-8"));
        assertArrayEquals("SHA-256",r,toHex(SHA256abc));
        
        md = new SHA384();
        r = md.digest("".getBytes("utf-8"));
        assertArrayEquals("SHA-384",r,toHex(SHA384e));

        r = md.digest("abc".getBytes("utf-8"));
        assertArrayEquals("SHA-384",r,toHex(SHA384abc));
        
        md = new SHA512();
        r = md.digest("".getBytes("utf-8"));
        assertArrayEquals("SHA-512",r,toHex(SHA512e));

        r = md.digest("abc".getBytes("utf-8"));
        assertArrayEquals("SHA-512",r,toHex(SHA512abc));

        md = new SHA512(224);
        r = md.digest("".getBytes("utf-8"));
        assertArrayEquals("SHA-512/224",r,toHex(SHA512224e));

        md = new SHA512256();
        r = md.digest("".getBytes("utf-8"));
        assertArrayEquals("SHA-512/256",r,toHex(SHA512256e));
