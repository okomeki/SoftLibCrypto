...
public class HMACTest {
    ...
    public void testHmacMD5() {
        ...
        dump(result);
        assertArrayEquals("HMAC-MD5:1", expResult, result);
//        Mac mac = new Mac(new HMACSpi(md));
        ...
        dump(result);
        assertArrayEquals("HMAC-MD5:2", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-MD5:3", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-MD5:4", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-MD5:5", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-MD5:6", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-MD5:7", expResult, result);
    }
    ...
    public void testHmacSHA1() {
        ...
        byte[] result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA1:1", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA1:2", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA1:3", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA1:4", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA1:5", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA1:6", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA1:7", expResult, result);
    }
    ...
    public void testHmacSHA2() {
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-224:1", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-256:1", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-384:1", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-512:1", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-224:2", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-256:2", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-384:2", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-512:2", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-224:3", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-256:3", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-384:3", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-512:3", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-224:4", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-256:4", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-384:4", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-512:4", expResult, result);
        ...
        result = instance.doFinal(src);
        dump(result);
        assertArrayEquals("HMAC-SHA-256:おまけ", expResult, result);
    }
}
