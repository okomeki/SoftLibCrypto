...
public class PKCS1 {
    ...
    public static final OBJECTIDENTIFIER md2WithRSAEncryption =PKCS1.sub(2);
    ...
    public static final OBJECTIDENTIFIER sha384WithRSAEncryption =PKCS1.sub(12);
    public static final OBJECTIDENTIFIER sha512WithRSAEncryption =PKCS1.sub(13);
    public static final OBJECTIDENTIFIER sha224WithRSAEncryption =PKCS1.sub(14);
    public static final OBJECTIDENTIFIER sha512_224WithRSAEncryption =PKCS1.sub(15);
    public static final OBJECTIDENTIFIER sha512_256WithRSAEncryption =PKCS1.sub(16);
// DigestAlgorithm へ
