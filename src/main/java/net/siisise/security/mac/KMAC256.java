...
import net.siisise.security.digest.cSHAKE256;
 ...
 * @deprecated まだ
 */
public class KMAC256 implements MAC {
    cSHAKE256 cshake;
    long L;
    ...
    public void init(byte[] key, int length, String S) {
        ...
        L = length;
        newX.write(SHA3Derived.bytepad(SHA3Derived.encode_string(key),136));
        cshake = new cSHAKE256(length, "KMAC", S);
    }
